...
static void print_usage(const char *prg)
{
	...
	fprintf(stderr, " -e    enable Fast Forward \n");
...
static int update_ipv4_entries(int map_fd)
{
	...
	ipv4_value.nat_saddr = htonl(0xC0A80202);
	ipv4_value.nat_daddr = htonl(0xC0A80102);
	ipv4_value.nat_sport = htons(1025);
	ipv4_value.nat_dport = htons(5001);
	ipv4_value.route_ifindex = lan_if;
	ipv4_value.mtu = 1500;

	ipv4_key.saddr = htonl(0xC0A80202);
	ipv4_key.daddr = htonl(0xC0A80102);
	ipv4_key.sport = htons(1025);
	ipv4_key.dport = htons(5001);
	ipv4_key.protocol = IPPROTO_UDP;
	...
	/* Uplink: ENET -> PCIe */
	ipv4_value.flags = FP_INFO_FLAG_FAST_PATH;
	ipv4_value.nat_saddr = htonl(0xC0A80102);
	ipv4_value.nat_daddr = htonl(0xC0A80202);
	ipv4_value.nat_sport = htons(1025);
	ipv4_value.nat_dport = htons(5001);
	ipv4_value.route_ifindex = wan_if;
	ipv4_value.mtu = 1500;

	ipv4_key.saddr = htonl(0xC0A80102);
	ipv4_key.daddr = htonl(0xC0A80202);
	ipv4_key.sport = htons(1025);
	ipv4_key.dport = htons(5001);
	ipv4_key.protocol = IPPROTO_UDP;
	...
	ipv4_value.flags = FP_INFO_FLAG_FAST_PATH;
	ipv4_value.nat_saddr = htonl(0xC0A80202);
	ipv4_value.nat_daddr = htonl(0xC0A80302);
	ipv4_value.nat_sport = htons(1025);
	ipv4_value.nat_dport = htons(5001);
	ipv4_value.route_ifindex = vlan_if;
	ipv4_value.mtu = 1500;

	ipv4_key.saddr = htonl(0xC0A80202);
	ipv4_key.daddr = htonl(0xC0A80302);
	ipv4_key.sport = htons(1025);
	ipv4_key.dport = htons(5001);
	ipv4_key.protocol = IPPROTO_UDP;
	...
	/* VLAN uplink */
	ipv4_value.flags = FP_INFO_FLAG_FAST_PATH;
	ipv4_value.nat_saddr = htonl(0xC0A80302);
	ipv4_value.nat_daddr = htonl(0xC0A80202);
	ipv4_value.nat_sport = htons(1025);
	ipv4_value.nat_dport = htons(5001);
	ipv4_value.route_ifindex = wan_if;
	...
	ipv4_key.saddr = htonl(0xC0A80302);
	ipv4_key.daddr = htonl(0xC0A80202);
	ipv4_key.sport = htons(1025);
	ipv4_key.dport = htons(5001);
	ipv4_key.protocol = IPPROTO_UDP;
	...
	/* NAT uplink */
	ipv4_value.flags = FP_INFO_FLAG_FAST_PATH;
	ipv4_value.nat_saddr = htonl(0x0A000201);
	ipv4_value.nat_daddr = htonl(0x0A000202);
	ipv4_value.nat_sport = htons(1025);
	ipv4_value.nat_dport = htons(5001);
	ipv4_value.route_ifindex = wan_if;
	ipv4_value.mtu = 1500;
	...
	ipv4_key.saddr = htonl(0xC0A80102);
	ipv4_key.daddr = htonl(0x0A000202);
	ipv4_key.sport = htons(1025);
	ipv4_key.dport = htons(5001);
	ipv4_key.protocol = IPPROTO_UDP;
	...
	/* NAT downlink */
	ipv4_value.flags = FP_INFO_FLAG_FAST_PATH;
	ipv4_value.nat_saddr = htonl(0x0A000202);
	ipv4_value.nat_daddr = htonl(0xC0A80102);
	ipv4_value.nat_sport = htons(1025);
	ipv4_value.nat_dport = htons(5001);
	ipv4_value.route_ifindex = lan_if;
	...
	ipv4_key.saddr = htonl(0x0A000202);
	ipv4_key.daddr = htonl(0x0A000201);
	ipv4_key.sport = htons(1025);
	ipv4_key.dport = htons(5001);
	ipv4_key.protocol = IPPROTO_UDP;
	...
	/* VLAN/NAT uplink */
	ipv4_value.flags = FP_INFO_FLAG_FAST_PATH;
	ipv4_value.nat_saddr = htonl(0x0A000401);
	ipv4_value.nat_daddr = htonl(0x0A000402);
	ipv4_value.nat_sport = htons(1025);
	ipv4_value.nat_dport = htons(5001);
	ipv4_value.route_ifindex = wan_if;
	ipv4_value.mtu = 1500;
	...
	ipv4_key.saddr = htonl(0xC0A80302);
	ipv4_key.daddr = htonl(0x0A000402);
	ipv4_key.sport = htons(1025);
	ipv4_key.dport = htons(5001);
	ipv4_key.protocol = IPPROTO_UDP;
	...
	/* VLAN/NAT downlink */
	ipv4_value.flags = FP_INFO_FLAG_FAST_PATH;
	ipv4_value.nat_saddr = htonl(0x0A000402);
	ipv4_value.nat_daddr = htonl(0xC0A80302);
	ipv4_value.nat_sport = htons(1025);
	ipv4_value.nat_dport = htons(5001);
	ipv4_value.route_ifindex = vlan_if;
	...
	ipv4_key.saddr = htonl(0x0A000402);
	ipv4_key.daddr = htonl(0x0A000401);
	ipv4_key.sport = htons(1025);
	ipv4_key.dport = htons(5001);
	ipv4_key.protocol = IPPROTO_UDP;
	...
	/* Originator */
	/* Downlink: PCIe -> ENET */
	ipv4_value.flags = FP_INFO_FLAG_FAST_PATH | FP_INFO_FLAG_CONNTRACK_ORIG;
	ipv4_value.nat_saddr = htonl(0xC0A80202);
	ipv4_value.nat_daddr = htonl(0xC0A80102);
	ipv4_value.nat_sport = htons(1025);
	ipv4_value.nat_dport = htons(5001);
	...
	ipv4_value.nat_saddr = htonl(0xC0A80202);
	ipv4_value.nat_daddr = htonl(0xC0A80102);
	ipv4_value.nat_sport = htons(5001);
	ipv4_value.nat_dport = htons(1025);
	ipv4_value.route_ifindex = lan_if;
	ipv4_value.mtu = 1500;

	ipv4_key.saddr = htonl(0xC0A80202);
	ipv4_key.daddr = htonl(0xC0A80102);
	ipv4_key.sport = htons(5001);
	ipv4_key.dport = htons(1025);
	ipv4_key.protocol = IPPROTO_TCP;
